...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/deeppcb.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='D:/42/yolov5-mask-42-master/runs/train/exp186/weights/best.pt', help='model.pt path(s)')  #ROOT / 'yolov5s.pt'
